...
import 'package:b_safe/Screens/HomeMainScreen/FindLocalHelpScreen/serviceScreen.dart';
                      ...
                      itemBuilder: (ctx,index){
                        return InkWell(
                          onTap: (){
                            ...
                            // Get.to(ServiceScreen(servicesModel: __.servicesList![index],));
                          ...
                          child: FLHSwidget(
                            servicesModel: __.servicesList![index],
